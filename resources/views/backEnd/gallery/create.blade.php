      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-lg-8 mx-auto ">
                ...
                <!-- /.card-header -->
                <!-- form start -->
              <form class="form-horizontal" name="edit-form" action="{{ route('gallery.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" class="form-control{{ $errors->has('title') ? ' is-invalid' : '' }}" id="title" name="title" placeholder="Gallery Title" value="{{ old('title') }}" autofocus>
