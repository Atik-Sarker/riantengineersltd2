      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-lg-8 mx-auto ">
                ...
                <!-- /.card-header -->
                <!-- form start -->
              <form class="form-horizontal" name="edit-form" action="{{ route('service.update',$service->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" class="form-control{{ $errors->has('title') ? ' is-invalid' : '' }}" id="title" name="title" placeholder="Gallery Title" value="{{ old('title') ? old('title') : $service->title }}" autofocus>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <textarea class="form-control{{ $errors->has('description') ? ' is-invalid' : '' }}" placeholder="Service description" name="description">{{ old('description') ? old('description') : $service->description }}</textarea>
