                ...
                @csrf
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" class="form-control{{ $errors->has('slider_name') ? ' is-invalid' : '' }}" id="slider_name" name="slider_name" value="{{ old('slider_name') }}">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" class="form-control{{ $errors->has('slider_subtitle') ? ' is-invalid' : '' }}" id="slider_subtitle" name="slider_subtitle" value="{{ old('slider_subtitle') }}">
